...
const { Menu, BattleMenuOptions, GameMenuOptions, GameEndOptions, StartMenuOptions } = require('./Menu.js');
...
class Game {
    ...
    #loot = []; //strictly private
    #score = 0; //strictly private
    #genieSpeach = ""; //strictly private
    #enemySeed = {
...
I shall call you ${CH.insert_format(
    ...
    battleOptions = new GameState(() => {
        ...
        () => {
            CH.clear_last_line();
            let opts = Menu.battleMenuOptions;
    ...
    start = new GameState(() => { },
        ...
        (text) => {
            if (text === " ") {
                new GameStates().currentState = this.mainMenu;
            }
        });

    mainMenu = new GameState((onCreate) => {
